...
#ifndef _TFZQ_STP_TRADEOPT_QRYPOSITION_IN_H_
#define _TFZQ_STP_TRADEOPT_QRYPOSITION_IN_H_
...
public:
    ...
    QryPosition_In(void) : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    QryPosition_In(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    QryPosition_In(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
    ...
    QryPosition_In &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    QryPosition_In &wrapForDecode(
...
#pragma GCC diagnostic pop
    ...
    QryPosition_In &putInvestorID(const char *src)
    {
    ...
    QryPosition_In &putInvestorID(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    QryPosition_In &putExchangeID(const char *src)
    {
    ...
    QryPosition_In &putExchangeID(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    QryPosition_In &putInstrumentID(const char *src)
    {
    ...
    QryPosition_In &putInstrumentID(const std::string& str)
    {
