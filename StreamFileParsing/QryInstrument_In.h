...
#ifndef _TFZQ_STP_TRADEOPT_QRYINSTRUMENT_IN_H_
#define _TFZQ_STP_TRADEOPT_QRYINSTRUMENT_IN_H_
...
public:
    ...
    QryInstrument_In(void) : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    QryInstrument_In(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    QryInstrument_In(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
    ...
    QryInstrument_In &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    QryInstrument_In &wrapForDecode(
...
#pragma GCC diagnostic pop
    ...
    QryInstrument_In &putExchangeID(const char *src)
    {
    ...
    QryInstrument_In &putExchangeID(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    QryInstrument_In &putInstrumentID(const char *src)
    {
    ...
    QryInstrument_In &putInstrumentID(const std::string& str)
    {
