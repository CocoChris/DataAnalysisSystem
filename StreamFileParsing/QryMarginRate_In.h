...
#ifndef _TFZQ_STP_TRADEOPT_QRYMARGINRATE_IN_H_
#define _TFZQ_STP_TRADEOPT_QRYMARGINRATE_IN_H_
...
public:
    ...
    QryMarginRate_In(void) : m_buffer(nullptr), m_bufferLength(0), m_offset(0) {}

    QryMarginRate_In(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    QryMarginRate_In(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
    ...
    QryMarginRate_In &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    QryMarginRate_In &wrapForDecode(
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &putInvestorID(const char *src)
    {
    ...
    QryMarginRate_In &putInvestorID(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &putExchangeID(const char *src)
    {
    ...
    QryMarginRate_In &putExchangeID(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &putInstrumentID(const char *src)
    {
    ...
    QryMarginRate_In &putInstrumentID(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &direction(const char value)
    {
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &offsetFlag(const char value)
    {
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &coveredFlag(const char value)
    {
...
#pragma GCC diagnostic pop
    ...
    QryMarginRate_In &hedgeFlag(const char value)
    {
